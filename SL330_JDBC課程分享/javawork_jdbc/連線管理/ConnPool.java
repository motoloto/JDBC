...
public class ConnPool {
	...
	private Vector<Connection> freeConnections;             //JDK1.5 Generic
	private Hashtable<Thread, Connection> boundConnections; //JDK1.5 Generic
	...
	public synchronized Connection getConnection() throws SQLException {
		if (freeConnections == null)
			throw new SQLException(
					"The conection pool has not been established yet.");
