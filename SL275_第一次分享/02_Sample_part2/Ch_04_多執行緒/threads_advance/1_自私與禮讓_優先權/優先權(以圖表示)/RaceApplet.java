/**
   以圖表示 自私的執行緒(selfish thread) 及 時間分割(time-slicing)
*
/**
   檔案 : RaceApplet.html + RaceApplet.java + Runner.java
   執行 : AppletViewer RaceApplet.html  
*/
    ...
    public void update(Graphics g) {
        for (int i = 0; i < NUMRUNNERS; i++) {
            g.drawLine(SPACING, (i+1)*SPACING, 
		       SPACING + (runners[i].tick)/1000000, (i+1)*SPACING);
        }
    }
